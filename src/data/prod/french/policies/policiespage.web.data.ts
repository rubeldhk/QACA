...
const policiesPageTestData: { [key: string]: PoliciesPageTestCaseData } = {
    ...
    '0002-verify-policies': {
        ...
        testCaseData: {
            tags: "@regression @policies @french",
            testCase: "BM-0084",
            testDescription: "Verify that the user can successfully navigate to the 'Politique de commande et de retour' page.",
            testSummary: "Verify that the user can successfully navigate to the 'Politique de commande et de retour' page.",
        },
    },
    ...
    '0006-verify-policies': {
        ...
        headingVerification: "Politique d'intimité",
        flowerCareVerification: {
            flowerCareHeading:'',
    ...
    '0008-verify-policies': {
        ...
        testCaseData: {
            tags: "@regression @policies @french",
            testCase: "BM-0090",
            testDescription: "Verify that the user can successfully navigate to the 'FAQ' page.",
            testSummary: "Verify that the user can successfully navigate to the 'FAQ' page.",
        },
    },
};
