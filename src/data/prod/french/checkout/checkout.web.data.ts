...
const checkoutTestData: { [key: string]: CheckoutTestCaseData } = {
  "0001-verify-checkout": {
    cartHeading: "RÉSUMÉ DU PANIER",
    addtocart: "Magasinez",
    productQuantity: "1",
    proceedToCheckout: "Passer à la caisse",
    proceedToCheckoutButtonOnCartPage: "COMMANDER",
    ...
    Username - ${email1}`,
    testCaseData: {
      tags: "@regression @checkout @french",
      testCase: "BMX-0181",
  ...
  "0002-verify-checkout-and-pay": {
    ...
    postcode: generateRandomNumber(6),
    city: TestDataUtils.generateRandomCity(),
    emailSubject:`Profil de ${firstName}  inscrit � Bloomex - Order Flowers Quickly and Securely for Canada Delivery :: Order from a Trusted Canadian Online Florist`,
    emailBody: `Bonjour ${firstName} ,

Merci de vous �tre enregistr�(e) sur Bloomex - Order Flowers Quickly and Securely for Canada Delivery :: Order from a Trusted Canadian Online Florist.

Vous pouvez maintenant vous connecter � https://bloomex.ca en utilisant votre nom d'utilisateur et mot de passe choisis lors de votre inscription.`,
    testCaseData: {
      tags: "@regression @checkout @french",
      testCase: "BMX-0182",
