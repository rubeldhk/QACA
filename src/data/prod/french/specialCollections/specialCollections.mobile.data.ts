...
import {
  SelectSpecialCollectionsItemDataFrench,
  ExpectedSpecialCollectionsValuesDataFrench,
  ExpectedSpecialCollectionsPageHeadingsDataFrench,
} from "@interfaces/specialCollections/specialCollections.interface";

interface SpecialCollectionsTestCaseData {
  specialCollections?: { dropdown: string };
  selectSpecialCollectionsItem?: SelectSpecialCollectionsItemDataFrench;
  expectedSpecialCollectionsValues?: string[];
  expectedPageHeader?: ExpectedSpecialCollectionsValuesDataFrench;
  expectedPageHeadings?: ExpectedSpecialCollectionsPageHeadingsDataFrench;
  testCaseData: TestCaseData;
}

const specialCollectionsTestData: { [key: string]: SpecialCollectionsTestCaseData } = {
  "0001-verify-special-collections-mobile": {
    specialCollections: {
      dropdown: "Spéciaux",
    },
  ...
  "0002-mason-jar-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Collection Bocal de Maçon",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0006",
  ...
  "0003-designer-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Collection de Créateurs",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0007",
  ...
  "0004-gourmet-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Collection Gourmet",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0008",
  ...
  "0005-roses-and-wine-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Roses et vin",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0009",
  ...
  "0006-lindt-gift-baskets-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Paniers Cadeaux Lindt - 50% prix",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0010",
  ...
  "0007-the-bunches-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Collection Poignée de Fleurs",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0011",
  ...
  "0008-birthday-mug-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Collection-chope-anniversaire",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0012",
  ...
  "0010-teddy-bears-vases-and-chocolates-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Ours en Peluche, Vases et Chocolats",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0014",
  ...
  "0011-shop-for-good-collection-mobile": {
    selectSpecialCollectionsItem: {
      isWeb: false,
      specialCollectionsItem: "Magasiner pour la bonté",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0015",
  ...
  "0012-mason-jar-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Collection Bocal de Maçon",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0116",
  ...
  "0013-designer-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Collection du Créateur",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0117",
  ...
  "0014-gourmet-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Collection Gourmande",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0118",
  ...
  "0015-roses-and-wine-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Spéciales des Roses & Vin",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0119",
  ...
  "0016-lindt-gift-basket-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Paniers-Cadeaux de la Collection Lindt",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0120",
  ...
  "0017-the-bunches-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "La collection des grappes",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0121",
  ...
  "0018-birthday-mug-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Collection Chope dAnniversaire",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0122",
  ...
  "0019-bud-vase-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Livraison de fleurs le jour-même",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0123",
  ...
  "0020-cards-vases-and-teddy-bears-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Cartes, vases, ours en peluche, ballons et chocolats",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0124",
  ...
  "0021-shop-for-good-collection-page-header-mobile": {
    expectedPageHeader: {
      expectedSpecialCollectionsValueHeaders: "Magasiner pour la bonté",
    },
    testCaseData: {
      tags: " @smoke @regression @french ",
      testCase: "BM-0125",
  ...
  "0022-verify-special-collections-page-elements-mobile": {
    expectedPageHeadings: {
      headings: [
        "Collection Bocal de Maçon",
        "Collection du Créateur",
        "Collection Gourmande",
        "Spéciales des Roses & Vin",
        "Paniers-Cadeaux de la Collection Lindt",
        "La collection des grappes",
        "Collection Chope dAnniversaire",
        "Livraison de fleurs le jour-même",
        "Cartes, vases, ours en peluche, ballons et chocolats",
        "Magasiner pour la bonté",
      ],
    },
    testCaseData: {
