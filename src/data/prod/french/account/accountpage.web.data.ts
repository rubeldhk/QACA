...
const accountPageTestData: { [key: string]: AccountPageTestCaseData } = {
    ...
    '0010-verify-account': {
      ...
      hoursAndContactInformation: {
        HoursAndContactInformation: "Heures et informations de contact",
