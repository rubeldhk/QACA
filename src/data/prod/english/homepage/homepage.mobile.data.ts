...
const homepageTestData: { [key: string]: HomepageTestCaseData } = {
  ...
  "0017-verify-Things-Engraved-link": {
    ...
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0063",
      testDescription: "Verify that the 'Things-Engraved-link' is visible on the top on homepage",
      testSummary: "Verify that the 'Things-Engraved-link' is visible on the top on homepage",
    },
  },
  "0018-verify-Personalized-Gifts-for-any-occasion-link": {
    ...
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0064",
      testDescription: "Verify that the 'Personalized Gifts for any occasion' link is visible on the top on homepage",
      testSummary: "Verify that the 'Personalized Gifts for any occasion' link is visible on the top on homepage",
    },
  },
  "0019-verify-Same-Day-Flower-Delivery-Section": {
    text: "Same Day Flower Delivery",
    sectionDescription: "Bloomex Canada offers same day and next day delivery across Canada. With warehouses located across all major Canadian cities, our delivery network allows us to deliver fresh flowers locally, fast.",
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0065",
      testDescription: "Verify that 'Same Day Flower Delivery' Section is visible on the homepage",
      testSummary: "Verify that 'Same Day Flower Delivery' Section is visible on the homepage",
    },
  },
  "0020-verify-Designer-Collection-Section": {
    text: "Designer Collection",
    sectionDescription: "The Designer Collection allows our team of professional, on-staff Floral Designers to choose the freshest and best flowers in stock, and create unique bouquets and arrangements. The perfect choice for a custom curated fresh flower bouquet.",
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0066",
      testDescription: "Verify that 'Designer Collection' Section is visible on the homepage",
      testSummary: "Verify that 'Designer Collection' Section is visible on the homepage",
    },
  },
  "0021-verify-Gourmet-Collection-Section": {
    text: "Gourmet Collection",
    sectionDescription: "Our Gift Basket Gourmets have hunted down the most decadent treats ever and used them to create these Gift Baskets full of tempting treats. Comprised solely of the most luxurious treats these completely irresistible visions of a gift baskets are as good as it gets.",
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0067",
      testDescription: "Verify that 'Gourmet Collection' Section is visible on the homepage",
      testSummary: "Verify that 'Gourmet Collection' Section is visible on the homepage",
    },
  },
  "0022-verify-Site-Map-link-and-copyright-text": {
    ...
    copyrightText: " © 2005-2025 Bloomex - Order Flowers Quickly and Securely for Canada Delivery :: Order from a Trusted Canadian Online Florist",
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0071",
      testDescription: "Verify that the 'Site Map' link and copyright text is visible and accessible on the homepage footer",
      testSummary: "Verify that the 'Site Map' link and copyright text is visible and accessible on the homepage footer",
    },
  },
  "0023-verify-Collection-menu": {
    ...
    testCaseData: {
      tags: "@regression @homepage @english",
      testCase: "BM-0068",
      testDescription: "Verify that the Flowers Collection menu is visible on the homepage",
      testSummary: "Verify that the Flowers Collection menu is visible on the homepage",
    },
  },
