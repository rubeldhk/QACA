...
test.describe("Account Page", () => {
  ...
  `, async ({ homepagePage, commonUtils }) => {
    ...
    await test.step("AND the user verifies account menu items are visible", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario2.pageName, scenario2.menuItem);
  });
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario3.pageName, scenario3.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario4.pageName, scenario4.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario5.pageName, scenario5.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario6.pageName, scenario6.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
    await accountPage.verifyPageTitle(scenario6.title);
  });
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario7.pageName, scenario7.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
    await accountPage.verifyPageTitle(scenario7.title);
  });
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario8.pageName, scenario8.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario9.pageName, scenario9.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario10.pageName, scenario10.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario11.pageName, scenario11.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario12.pageName, scenario12.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
...
`, async ({ homepagePage, commonUtils, accountPage }) => {
  ...
  await test.step("AND the user navigates to the account page", async () => {
    await homepagePage.navigateToMobileMenu(scenario13.pageName, scenario13.menuItem);
  });
  await test.step("AND the user verifies the account page title", async () => {
  ...
  `, async ({ homepagePage, commonUtils, accountPage }) => {
    ...
    await test.step("AND the user navigates to the account page", async () => {
      await homepagePage.navigateToMobileMenu(scenario14.pageName, scenario14.menuItem);
    });
    await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario15.pageName, scenario15.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
        await accountPage.verifyHeadingofAccountPage(scenario15.title);
      });
      await test.step("AND the user verifies the shopping cart form", async () => {
        await accountPage.verifyShoppingCartForm(scenario15.shoppingCartHeading);
        });
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario16.pageName, scenario16.menuItem);
      });
    await test.step("AND the user verifies the account page title", async () => {
      await accountPage.verifyHeadingofAccountPage(scenario16.title);
    });
    await test.step("AND the user verifies the hours and contact information", async () => {
      await accountPage.verifyHoursAndContactInformation(scenario16.hoursAndContactInformation);
    });
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario17.pageName, scenario17.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario18.pageName, scenario18.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario19.pageName, scenario19.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario20.pageName, scenario20.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario21.pageName, scenario21.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario22.pageName, scenario22.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario23.pageName, scenario23.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
    ...
    `, async ({ homepagePage, commonUtils, accountPage }) => {
      ...
      await test.step("AND the user navigates to the account page", async () => {
        await homepagePage.navigateToMobileMenu(scenario24.pageName, scenario24.menuItem);
      });
      await test.step("AND the user verifies the account page title", async () => {
