...
test.describe("Price Page", () => {
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario11.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario11.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario12.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario12.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
