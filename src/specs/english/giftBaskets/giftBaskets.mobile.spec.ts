...
test.describe("Flowers & Plants Page", () => {
  ...
  test(`Test case: '${scenario1.testCaseData.testCase}'
    ...
    await test.step("THEN the user verifies Flowers & Plants dropdown values match expected", async () => {
      await flowersAndPlantsPage.verifyFlowersAndPlantsDropdownValuesMatchMobile(
  ...
  test(`Test case: '${scenario3.testCaseData.testCase}'
    ...
    await test.step("AND the user expands Flowers & Plants page elements", async () => {
      await flowersAndPlantsPage.openFlowersAndPlantsDropdown(false);
    });
