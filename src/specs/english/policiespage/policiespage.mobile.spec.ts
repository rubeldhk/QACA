...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    await homepagePage.navigateToMobileMenu(scenario2.pageName);
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario2.menuItem);
  });
...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    ...
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario3.menuItem);
  });
  await test.step("AND the user verifies the policies page title", async () => {
...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    ...
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario4.menuItem);
  });
  await test.step("AND the user verifies the policies page title", async () => {
...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    ...
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario5.menuItem);
  });
  await test.step("AND the user verifies the policies page title", async () => {
  ...
  await test.step("AND the user verifies the flower care verification", async () => {
    await accountPage.verifyFlowerCareVerification(scenario5.flowerCareVerification);
  });
})
...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    ...
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario6.menuItem);
  });
  await test.step("AND the user verifies the policies page title", async () => {
...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    ...
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario7.menuItem);
  });
  await test.step("AND the user verifies the policies page title", async () => {
  ...
  await test.step("AND the user verifies the flower care verification", async () => {
    await accountPage.verifyFlowerCareVerification(scenario7.flowerCareVerification);
  });
})
...
`, async ({ homepagePage, commonUtils, policiesPage,accountPage }) => {
  ...
  await test.step("AND the user verifies the policies page nav menu items", async () => {
    ...
    await policiesPage.navigatetoMobilePoliciesPageItem(scenario8.menuItem);
  });
  await test.step("AND the user verifies the policies page title", async () => {
