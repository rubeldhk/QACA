...
test.describe("Price Page", () => {
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario1.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario1.menuItem);
    });
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario1.productData.productName, scenario1.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario1.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario1.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario2.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario2.productData.productName, scenario2.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario2.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario3.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario3.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario3.productData.productName, scenario3.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario3.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario4.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario4.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario4.productData.productName, scenario4.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario4.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario5.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario5.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario5.productData.productName, scenario5.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario5.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario6.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario6.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario6.productData.productName, scenario6.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario6.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario7.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario7.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario7.productData.productName, scenario7.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario7.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario8.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario8.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario8.productData.productName, scenario8.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario8.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario9.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario9.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario9.productData.productName, scenario9.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario9.taglineVerification);
    });
  });
  ...
  `, async ({ commonUtils, homepagePage,pricePage,accountPage,bestSellersPage }) => {
    ...
    await test.step("AND the user verifies the policies page nav menu items", async () => {
      await homepagePage.navigateToMobileMenu(scenario10.pageName);
      await pricePage.navigatetoMobilePricePageItem(scenario10.menuItem);
    });
    await test.step("AND the user verifies the price page title", async () => {
    ...
    await test.step("AND the user verifies the price page products", async () => {
      await pricePage.verifyPricePageProducts(scenario10.productData.productName, scenario10.productData.buttonText);
    });
    await test.step("AND the user verifies the tagline", async () => {
      await pricePage.verifyTagline(scenario10.taglineVerification);
    });
  });
